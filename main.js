...
(function() {
  var Canvas, Chart, Checkbox, Emitter, Particle, Scope, Simulation, StopButton, Vector, WebFontConfig, char, chart, cos, d3Object, f, min, ode, pi, repRow, rk, sin, vfPoint, xMax, yMax, _ref,
  ...
  Simulation = (function() {
    ...
    Simulation.prototype.snapshot = function() {
      ...
      chart.moveMarker(chart.marker1, this.vfp1.pos.x, this.vfp1.pos.y);
