...
(function() {
  var Canvas, Checkbox, DistSim, Emitter, IntroSim, Oscillator, Particle, Scope, Vector, WebFontConfig, char, cos, d3Object, f, introSim, min, ode, pi, repRow, rk, sin, vfPoint, xMax, yMax, _ref,
  ...
  DistSim = (function() {
    ...
    DistSim.prototype.snapshot = function() {
      ...
      return this.scope.screen.selectAll('path.trace').attr("d", this.scope.line);
    };
