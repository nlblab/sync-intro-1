...
(function() {
  var Canvas, Checkbox, DistSim, Emitter, IntroSim, Oscillator, Particle, Scope, Vector, WebFontConfig, char, cos, d3Object, distSim, f, min, ode, pi, repRow, rk, sin, vfPoint, xMax, yMax, _ref,
  ...
  Oscillator = (function(_super) {
    ...
    function Oscillator(X) {
      ...
      this.limitCircle = this.obj.append("circle").attr("cx", this.xscale(0) + margin.left).attr("cy", this.yscale(0) + margin.top).attr("r", this.xscale(2) - this.xscale(0)).style("fill", "transparent").style("stroke", "ccc");
      this.marker0 = this.obj.append("circle").attr("r", 5).style("fill", "black").style("stroke", "000").style("stroke-width", "1").call(d3.behavior.drag().origin(function() {
        return {
  ...
  DistSim = (function() {
    ...
    function DistSim() {
      ...
      this.markerPoint0 = new vfPoint;
      this.markerPoint0.pos.x = this.markerPoint0.x(3);
      this.markerPoint0.pos.y = this.markerPoint0.y(-3);
      this.markerPoint0.mu = 0.1;
      this.markerPoint1 = new vfPoint;
      this.markerPoint1.pos.x = this.markerPoint1.x(3);
      this.markerPoint1.pos.y = this.markerPoint1.y(2);
      this.markerPoint1.mu = 0.1;
    ...
    DistSim.prototype.drawMarker = function() {
      this.markerPoint0.move();
      this.markerPoint1.move();
      this.oscillator.moveMarker(this.oscillator.marker0, this.markerPoint0.pos.x, this.markerPoint0.pos.y);
      return this.oscillator.moveMarker(this.oscillator.marker1, this.markerPoint1.pos.x, this.markerPoint1.pos.y);
    };
